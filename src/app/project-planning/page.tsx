...
export default function ProjectPlanningPage() {
  ...
  const handleAddForecast = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!selectedProjectId) return;
    const res = await apiClient<{ success: boolean; data: any }>('/api/allocations', {
      method: 'POST',
      body: { ...allocationForm, projectId: selectedProjectId, status: 'forecast' },
    });
    const data = res;
    if (data.success) {
      setAllocations(a => [...a, data.data]);
        ...
        <div className="max-w-7xl mx-auto py-8 px-4">
          ...
          {selectedProjectId && (
            <div className="mb-8">
              ...
              <form onSubmit={handleAddForecast} className="flex flex-wrap gap-2 items-end mb-4">
                <select
                  name="role"
                ...
                <input
                  ...
                  required
                />
                <button type="submit" className="bg-green-600 text-white px-3 py-1 rounded">Add Forecast</button>
              </form>
                            ...
                            <div className="mt-2">
                              ...
                              <div className="flex flex-wrap gap-2 mt-1">
                                ...
                                >
                                  ...
                                  {skills.filter(s => !allocations.some(a => a.requiredSkills.some((rs: any) => rs.skillId === s.id))).map(skill => (
          ...
          {/* After forecasts table, render matrix view if forecasts exist */}
          {selectedProjectId && forecasts.length > 0 && (
            <div className="mt-8">
